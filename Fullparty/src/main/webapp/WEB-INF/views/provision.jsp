...
<title>서비스 이용약관 | Full Stay 별내점</title>
</head>
<body>
...
<br><br><br>
    ...
    <div id="ctt_con">
        <div>
	<p class="p01">제1장 총 칙</p>
	<div class="cont_box">
		<p class="p02">제1조(목적)</p>
		<p class="p03">
		이 약관은 키즈풀파티룸(풀스테이)(이하 "회사"라 한다) 홈페이지에서 제공하는 모든 서비스(이하 "서비스"라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.
		</p>
	</div>

	<div class="cont_box">
		<p class="p02">제2조(정의)</p>
		<p class="p03">
	...
	<p class="p01">제2장 서비스 이용계약</p>

	<div class="cont_box">
		<p class="p02">제5조(이용계약의 성립)</p>
		<p class="p03">
	...
	<div class="cont_box">
		...
		기타 회사가 정한 이용신청 요건에 미비 되었을 때<br>
		제8조(계약사항의 변경)<br>
		회원은 이용신청시 기재한 사항이 변경되었을 경우에는 수정하여야 하며, 수정하지 아니하여 발생하는 문제의 책임은 회원에게 있습니다.
		</p>
	</div>
	
	<p class="p01">제3장 계약당사자의 의무</p>

	<div class="cont_box">
		<p class="p02">제9조(회사의 의무)</p>
		<p class="p03">
	...
	<p class="p01">제4장 서비스 이용</p>

	<div class="cont_box">
		<p class="p02">제11조(회원의 의무)</p>
		<p class="p03">
	...
	<div class="cont_box">
		<p class="p02">제12조(게시물 관리 및 삭제)</p>
		<p class="p03">
	...
	<p class="p01">제5장 계약해지 및 이용제한</p>

	<div class="cont_box">
		<p class="p02">제17조(계약해지 및 이용제한) </p>
		<p class="p03">
	...
	<p class="p01">제6장 기 타</p>

	<div class="cont_box">
		<p class="p02">제18조(양도금지)</p>
		<p class="p03">회원은 서비스의 이용권한, 기타 이용계약상의 지위를 타인에게 양도, 증여할 수 없으며, 이를 담보로 제공할 수 없습니다.</p>
	</div>
	
	<div class="cont_box">
		<p class="p02">제19조(손해배상)</p>
		<p class="p03">
	...
	<div class="cont_box">
		<p class="p02">제21조(관할법원)</p>
		<p class="p03">서비스 이용으로 발생한 분쟁에 대해 소송이 제기 될 경우 회사의 소재지를 관할하는 법원을 전속 관할법원으로 합니다.</p>
	</div>

	<p class="p01">부 칙</p>

	<div class="cont_box">
		<p class="p03">(시행일) 이 약관은 2022년 1월 1일부터 시행합니다.</p>
	</div>
</div>    </div>
</div>
